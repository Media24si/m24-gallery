      ...
      <div class="gallery">
        <div>
          ...
          <div>
            ...
            <span>{{ currentlySelectedImagePosition }} / {{ images.length }}</span>
            <span @click.prevent="closeGallery">
        ...
        <div class="main-image group">
          ...
          <div class="zoom invisible opacity-0 group-hover:visible group-hover:opacity-100" @click.prevent="openGallery">
          ...
          <div class="navigation">
            <button class="mr-2" @click.prevent="previous">
              <span>
        ...
        <div class="thumbs">
          <div :style="thumbMoveStyle">
            <div :class="{ active: image.id === displayedImage.id, 'w-1/4': !isExpanded, 'w-1/6': isExpanded }" v-for="(image, index) in images" :key="image.id" @click.prevent="switchDisplayedImage(image, index)">
              <picture>
        ...
        <div class="description">
          <p v-if="displayedImage.description !== ''">{{ displayedImage.description }}</p>
          <p v-if="displayedImage.author !== ''">Foto: {{ displayedImage.author }}</p>
        </div>
      </div>
    </div>
  </div>
