      ...
      <div class="m24g-gallery m24g-relative m24g-p-2 m24g-pt-0">
        <div class="m24g-flex m24g-justify-between m24g-items-center m24g-py-2">
          ...
          <div class="m24g-flex m24g-items-center m24g-justify-center">
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="images" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="m24g-w-5 m24g-h-5">
            ...
            <span class="m24g-pl-2">{{ currentlySelectedImagePosition }} / {{ images.length }}</span>
            <span class="m24g-pl-2 m24g-cursor-pointer m24g-hidden" @click.prevent="closeGallery">
              <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="times" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="m24g-w-5 m24g-h-5">
        ...
        <div class="m24g-main-image m24g-relative m24g-flex m24g-items-center m24g-justify-center m24g-group">
          ...
          <div class="m24g-navigation m24g-absolute m24g-top-0 m24g-left-0 m24g-w-full m24g-h-full m24g-flex m24g-justify-between m24g-items-center">
            ...
            <button class="m24g-p-2 m24g-h-8 m24g-w-8 m24g-flex m24g-items-center m24g-justify-center" @click.prevent="next">
              <span>
                <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" class="m24g-w-4 m24g-h-4"><path fill="currentColor" d="M24.707 38.101L4.908 57.899c-4.686 4.686-4.686 12.284 0 16.971L185.607 256 4.908 437.13c-4.686 4.686-4.686 12.284 0 16.971L24.707 473.9c4.686 4.686 12.284 4.686 16.971 0l209.414-209.414c4.686-4.686 4.686-12.284 0-16.971L41.678 38.101c-4.687-4.687-12.285-4.687-16.971 0z" class=""></path></svg>
              </span>
            </button>
          </div>
        </div>
        <div class="m24g-thumbs m24g-flex m24g-w-full m24g-pt-2 m24g-overflow-x-hidden">
          <div class="m24g-flex m24g-w-full" :style="thumbMoveStyle">
            <div class="m24g-border-4 m24g-border-transparent m24g-cursor-pointer m24g-flex-shrink-0" :class="{ active: image.id === displayedImage.id, 'm24g-w-1/4': !isExpanded, 'm24g-w-1/6': isExpanded }" v-for="(image, index) in images" :key="image.id" @click.prevent="switchDisplayedImage(image, index)">
              <picture>
                <img class="m24g-w-full" :src="image.url | crop(thumbWidthSize, thumbHeightSize)" :alt="image.title">
              </picture>
            </div>
          </div>
        </div>
